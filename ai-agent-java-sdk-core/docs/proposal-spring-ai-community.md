...
- `AiAgent` - main entry point with `execute()` (sync) and `executeStreaming()` (`Flux<String>`)
- `AgentExecutionLoop` - iterative model-tool reasoning loop with max iterations, retry logic, and conversation management
...
- `AgentPlugin` interface with `PluginScanner` for auto-discovery of hooks and tool providers
...
**Observability:**
- `AgentObservability` with Micrometer metrics and Observation API tracing spans
...
- Immutable `AgentExecutionContext` with headers excluded from toString/equals/hashCode

**Configuration:**
- `AiAgentProperties` under `ai.agent.*` with Jakarta Validation
...
https://github.com/vaquarkhan/ai-agent-java-sdk-core

## Integration with Spring AI

ai-agent-java-sdk-core integrates directly with Spring AI's existing APIs without modifying or replacing any core components:
...
**spring-ai-agentcore composition** - The `AiAgent` bean is callable from `@AgentCoreInvocation`-annotated methods. Session context propagates from `AgentCoreContext` to `AgentExecutionContext`. SSE streaming works through the existing runtime starter.

**spring-ai-a2a composition** - The `AiAgent` can serve as the executor behind A2A protocol endpoints for multi-agent orchestration.
...
- [README](https://github.com/vaquarkhan/ai-agent-java-sdk-core/blob/main/ai-agent-java-sdk-core/README.md)
- [Tutorial](https://github.com/vaquarkhan/ai-agent-java-sdk-core/blob/main/ai-agent-java-sdk-core/docs/tutorial.md)
- [Developer Guide](https://github.com/vaquarkhan/ai-agent-java-sdk-core/blob/main/ai-agent-java-sdk-core/docs/developer-guide.md)
- [Python vs Java Comparison](https://github.com/vaquarkhan/ai-agent-java-sdk-core/blob/main/ai-agent-java-sdk-core/docs/python-strands-vs-ai-agent-java.md)
