...
import com.example.spring.ai.agent.hook.HookAnnotationProcessor;
 ...
 * <ul>
 *   <li>{@link com.example.spring.ai.agent.hook.OnHook @OnHook} annotated methods
 *       are registered as hooks</li>
 *   <li>Methods returning {@link ToolCallbackProvider} are invoked and their tools
 *       can be registered</li>
 * </ul>
 *
 * <p>Called during {@link com.example.spring.ai.agent.AiAgent#initPlugins()}.
 *
 * @author Vaquar Khan
 */
