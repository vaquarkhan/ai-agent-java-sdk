 ...
 * <ul>
 *   <li>{@link com.example.spring.ai.agent.tool.ToolRegistry} - argument size limits,
 *       execution timeouts, rate limiting, and tool name validation</li>
 *   <li>{@link com.example.spring.ai.agent.config.AiAgentProperties} - SSRF prevention,
 *       actuator property hiding, and configuration validation</li>
 *   <li>{@link com.example.spring.ai.agent.observability.AgentObservability} - output
