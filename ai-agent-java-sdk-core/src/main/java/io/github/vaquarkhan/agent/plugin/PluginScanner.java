...
import io.github.vaquarkhan.agent.hook.HookAnnotationProcessor;
 ...
 * <ul>
 *   <li>{@link io.github.vaquarkhan.agent.hook.OnHook @OnHook} annotated methods
 *       are registered as hooks</li>
 *   <li>Methods returning {@link ToolCallbackProvider} are invoked and their tools
 *       can be registered</li>
 * </ul>
 *
 * <p>Called during {@link io.github.vaquarkhan.agent.AiAgent#initPlugins()}.
 *
 * @author Vaquar Khan
 */
