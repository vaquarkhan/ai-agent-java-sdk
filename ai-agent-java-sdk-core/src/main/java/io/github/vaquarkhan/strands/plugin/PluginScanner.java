...
import io.github.vaquarkhan.strands.hook.HookAnnotationProcessor;
...
/**
 * Scans a {@link AgentPlugin} implementation for auto-discoverable features:
 * <ul>
 *   <li>{@link io.github.vaquarkhan.strands.hook.OnHook @OnHook} annotated methods
 *       are registered as hooks</li>
 *   <li>Methods returning {@link ToolCallbackProvider} are invoked and their tools
 *       can be registered</li>
 * </ul>
 *
 * <p>Called during {@link io.github.vaquarkhan.strands.AiAgent#initPlugins()}.
 *
 * @author Vaquar Khan
 */
public class PluginScanner {
     ...
     */
    public ScanResult scan(AgentPlugin plugin) {
        if (plugin == null) {
    ...
    private int scanForToolProviders(AgentPlugin plugin) {
        int count = 0;
