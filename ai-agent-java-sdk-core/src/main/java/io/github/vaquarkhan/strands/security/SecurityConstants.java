 ...
 * <ul>
 *   <li>{@link io.github.vaquarkhan.strands.tool.ToolRegistry} - argument size limits,
 *       execution timeouts, rate limiting, and tool name validation</li>
 *   <li>{@link io.github.vaquarkhan.strands.config.AiAgentProperties} - SSRF prevention,
 *       actuator property hiding, and configuration validation</li>
 *   <li>{@link io.github.vaquarkhan.strands.observability.AgentObservability} - output
