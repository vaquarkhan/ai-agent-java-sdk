...
class AgentObservabilityTest {
    ...
    void tracesAndMetricsRecorded() {
        ...
        AgentObservability observability = new AgentObservability(meterRegistry, ObservationRegistry.NOOP, security);
        var trace = observability.startTrace("agent", AgentExecutionContext.standalone("s1"));
