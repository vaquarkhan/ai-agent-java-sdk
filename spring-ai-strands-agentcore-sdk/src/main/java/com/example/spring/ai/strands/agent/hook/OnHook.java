...
/**
 * Marks a method as a hook handler for a specific {@link StrandsHookEvent} type.
 *
 * <p>Annotated methods must accept a single parameter of type {@link StrandsHookEvent}
...
public @interface OnHook {
     ...
     */
    Class<? extends StrandsHookEvent> value();
}
