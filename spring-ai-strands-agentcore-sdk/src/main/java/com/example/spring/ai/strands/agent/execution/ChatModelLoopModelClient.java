...
/**
 * Bridge between Spring AI's {@link ChatModel} and the Strands {@link LoopModelClient} interface.
 *
 * <p>This class calls {@code ChatModel.call(Prompt)} directly (not {@code ChatClient}) so that
 * the {@link StrandsExecutionLoop} retains full control over the tool execution cycle. Tool
...
public class ChatModelLoopModelClient implements LoopModelClient {
    ...
    /**
     * Converts the Strands execution messages to Spring AI message types.
     */
    ...
    /**
     * Maps a Spring AI {@link ChatResponse} to a Strands {@link ModelTurnResponse}.
     */
