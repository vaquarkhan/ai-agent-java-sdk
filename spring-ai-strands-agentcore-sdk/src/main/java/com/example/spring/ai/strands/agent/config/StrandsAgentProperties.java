 ...
 * @author Vaquar Khan
 */
@ConfigurationProperties(prefix = "strands.agent")
@Validated
public class StrandsAgentProperties {
    ...
    @AssertTrue(message = "strands.agent.system-prompt and strands.agent.system-prompt-resource are mutually exclusive")
    public boolean isSystemPromptConfigurationValid() {
        return systemPrompt == null || systemPrompt.isBlank() || systemPromptResource == null;
    }

    @AssertTrue(message = "strands.agent.system-prompt-resource cannot use http:// or https://")
